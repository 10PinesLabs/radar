  ...
  def serialized_radar_template_container(radar_template_container)
    {
        ...
        'active_voting_data' => serialize_radar_template_container_voting(radar_template_container.active_voting),
  ...
  context 'When logged in as a valid user' do
    ...
    describe '#index' do
      ...
      context 'if a container is inactive' do
        ...
        context 'and we ask for all containers including the inactive ones' do
          subject do
